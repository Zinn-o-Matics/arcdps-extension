function(get_git_version)
	...
	list(GET VERSION_LIST 0 VERSION_MAJOR_STR)
	list(GET VERSION_LIST 1 VERSION_MINOR_STR)
	list(GET VERSION_LIST 2 VERSION_PATCH_STR)

	# --- Parse major/minor/patch (numeric) ---
	string(REGEX REPLACE "[^0-9]" "" VERSION_MAJOR "${VERSION_MAJOR_STR}")
	string(REGEX REPLACE "[^0-9]" "" VERSION_MINOR "${VERSION_MINOR_STR}")
	string(REGEX REPLACE "[^0-9]" "" VERSION_PATCH "${VERSION_PATCH_STR}")
	...
	set(VERSION_MAJOR_STR "${VERSION_MAJOR_STR}" PARENT_SCOPE)
	set(VERSION_MINOR_STR "${VERSION_MINOR_STR}" PARENT_SCOPE)
	set(VERSION_PATCH_STR "${VERSION_PATCH_STR}" PARENT_SCOPE)
